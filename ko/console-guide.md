...
<table class="it">
  ...
  <tr>
    <td>기본 디스크 타입</td>
    <td>생성될 인스턴스의 기본 디스크의 타입. <br>범용 HDD, 범용 SSD 중 선택</td>
  </tr>
  <tr>
    <td>키페어</td>
  ...
  <tr>
    <td>추가 디스크 크기</td>
    <td>생성될 인스턴스에 추가적으로 할당할 디스크의 크기<br> 단위는 GB이며, 10 ~ 1000GB 내의 값만 허용</td>
  </tr>
  <tr>
    <td>추가 디스크 타입</td>
    <td>생성될 인스턴스에 추가적으로 할당할 디스크의 타입. <br>범용 HDD, 범용 SSD 중 선택</td>
  </tr>
  <tr>
    <td>사용자 스크립트</td>
